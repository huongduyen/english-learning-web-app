...
Kiến trúc xanh tích hợp thảm thực vật sống trực tiếp vào mặt đứng công trình. Vườn trên mái, rừng thẳng đứng và công viên cây xanh không chỉ làm đẹp thêm cho cảnh quan bê tông; chúng còn hấp thụ khí CO2, làm giảm nhiệt độ mùa hè và hạn chế hiệu ứng đảo nhiệt đô thị nguy hại.
  ...
  const quizzesData = [
    ...
    {
      title: 'Listening Check: Asking for Directions',
      description: 'Check your comprehension of locations, landmarks, and street directions.',
      level: EnglishLevel.ELEMENTARY,
      difficulty: Difficulty.EASY,
      timeLimit: 10,
      passingScore: 70,
      listeningLessonSlug: 'asking-for-directions',
      readingArticleSlug: null,
      grammarLessonSlug: null,
      questions: [
        {
          prompt: 'Which prominent landmark did the local advise the tourist to look out for?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'A golden cathedral spire' },
            { id: 'b', text: 'A tall brick clock tower' },
            { id: 'c', text: 'A glass shopping mall' },
            { id: 'd', text: 'A large stone bridge' },
          ],
          correctAnswer: 'b',
          explanation: 'The local instructed: "walk straight down this avenue until you see a tall brick clock tower."',
          explanationVi: 'Người dân hướng dẫn: "đi thẳng theo đại lộ này cho đến khi bạn thấy tháp đồng hồ bằng gạch cao."',
          points: 35,
        },
        {
          prompt: 'Where is the underground station entrance situated on Market Street?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Next to the public library' },
            { id: 'b', text: 'Opposite a post office' },
            { id: 'c', text: 'Inside the train museum' },
            { id: 'd', text: 'Behind the supermarket' },
          ],
          correctAnswer: 'a',
          explanation: 'The entrance is right next to the public library.',
          explanationVi: 'Lối vào ga tàu điện ngầm nằm ngay cạnh thư viện công cộng.',
          points: 35,
        },
        {
          prompt: 'The tourist is approximately fifteen minutes away from the station on foot.',
          questionType: QuestionType.TRUE_FALSE,
          options: [
            { id: 'true', text: 'True' },
            { id: 'false', text: 'False' },
          ...
          correctAnswer: 'false',
          explanation: 'The local stated the tourist is about five minutes away from King\'s Cross.',
          explanationVi: 'Người dân nói chỉ cách ga King\'s Cross khoảng 5 phút đi bộ.',
          points: 30,
        },
      ],
    },
    {
      title: 'Listening Check: Job Interview Introduction',
      description: 'Test your understanding of professional self-introductions and career background summaries.',
      level: EnglishLevel.INTERMEDIATE,
      difficulty: Difficulty.MEDIUM,
      timeLimit: 10,
      passingScore: 70,
      listeningLessonSlug: 'job-interview-introduction',
      readingArticleSlug: null,
      grammarLessonSlug: null,
      questions: [
        {
          prompt: 'How many years of professional software development experience does Linh have?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'One year' },
            { id: 'b', text: 'Over three years' },
            { id: 'c', text: 'Five years' },
            { id: 'd', text: 'Ten years' },
          ],
          correctAnswer: 'b',
          explanation: 'Linh states she has over three years of experience building modern web applications.',
          explanationVi: 'Linh nêu rõ cô có hơn ba năm kinh nghiệm xây dựng ứng dụng web.',
          points: 35,
        },
        {
          prompt: 'What major achievement did Linh accomplish at her previous fintech company?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Built an iOS app from scratch' },
            { id: 'b', text: 'Migrated frontend to React, boosting speed by 40%' },
            { id: 'c', text: 'Designed new branding logos' },
            { id: 'd', text: 'Managed corporate finances' },
          ],
          correctAnswer: 'b',
          explanation: 'She migrated the legacy frontend to React, improving loading speed by 40%.',
          explanationVi: 'Cô đã dẫn dắt chuyển đổi sang kiến trúc React, giúp tăng tốc độ tải trang 40%.',
          points: 35,
        },
        {
          prompt: 'Linh is applying for a role at an educational technology company.',
          questionType: QuestionType.TRUE_FALSE,
          options: [
            { id: 'true', text: 'True' },
            { id: 'false', text: 'False' },
          ...
          correctAnswer: 'true',
          explanation: 'Linh mentioned the company pioneers educational platforms for international learners.',
          explanationVi: 'Linh hào hứng vì công ty tiên phong phát triển các nền tảng giáo dục cho người học quốc tế.',
          points: 30,
        },
      ],
    },
    {
      title: 'Listening Check: Hotel Check-In',
      description: 'Assess comprehension of hotel reservation details, room types, and amenities.',
      level: EnglishLevel.ELEMENTARY,
      difficulty: Difficulty.EASY,
      timeLimit: 10,
      passingScore: 70,
      listeningLessonSlug: 'hotel-check-in',
      readingArticleSlug: null,
      grammarLessonSlug: null,
      questions: [
        {
          prompt: 'What room number was assigned to Mr. Nguyen?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Room 502' },
            { id: 'b', text: 'Room 604' },
          ...
          correctAnswer: 'c',
          explanation: 'The receptionist handed keycards for room 704.',
          explanationVi: 'Lễ tân giao thẻ từ phòng số 704.',
          points: 35,
        },
        {
          prompt: 'Where and when is the complimentary breakfast buffet served?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Ground floor, 6:00 AM to 9:00 AM' },
            { id: 'b', text: 'Second floor, 6:30 AM to 10:00 AM' },
            { id: 'c', text: 'Rooftop cafe, 7:00 AM to 11:00 AM' },
            { id: 'd', text: 'Room service only at 8:00 AM' },
          ],
          correctAnswer: 'b',
          explanation: 'Breakfast is on the second floor from 6:30 AM to 10:00 AM.',
          explanationVi: 'Buffet sáng phục vụ tại tầng 2 từ 6:30 đến 10:00 sáng.',
          points: 35,
        },
        {
          prompt: 'Mr. Nguyen reserved a single room with a garden view.',
          questionType: QuestionType.TRUE_FALSE,
          options: [
            { id: 'true', text: 'True' },
            { id: 'false', text: 'False' },
          ...
          correctAnswer: 'false',
          explanation: 'The reservation was for a deluxe king room with ocean view.',
          explanationVi: 'Phòng đặt là phòng Deluxe giường đôi hướng biển, không phải hướng vườn.',
          points: 30,
        },
      ],
    },
    {
      title: 'Listening Check: Weekend Plans',
      description: 'Evaluate comprehension of casual conversation, social invites, and outdoor trip planning.',
      level: EnglishLevel.BEGINNER,
      difficulty: Difficulty.EASY,
      timeLimit: 10,
      passingScore: 70,
      listeningLessonSlug: 'discussing-weekend-plans',
      readingArticleSlug: null,
      grammarLessonSlug: null,
      questions: [
        {
          prompt: 'Where are Alex and his friends planning to go camping?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Cuc Phuong National Park' },
            { id: 'b', text: 'Ba Vi National Park' },
            { id: 'c', text: 'Cat Ba Island' },
            { id: 'd', text: 'Tam Dao Mountain' },
          ],
          correctAnswer: 'b',
          explanation: 'Alex invites Mai to a camping trip near Ba Vi National Park.',
          explanationVi: 'Alex rủ Mai đi cắm trại ở Vườn quốc gia Ba Vì.',
          points: 35,
        },
        {
          prompt: 'What personal items did Alex advise Mai to pack?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'A heavy tent and grill' },
            { id: 'b', text: 'A warm jacket, hiking shoes, and a camera' },
            { id: 'c', text: 'Swimming gear and sunglasses' },
            { id: 'd', text: 'A laptop and textbooks' },
          ],
          correctAnswer: 'b',
          explanation: 'Alex said: "Just bring a warm jacket, good hiking shoes, and your camera."',
          explanationVi: 'Alex dặn: "Chỉ cần mang áo khoác ấm, giày leo núi tốt và máy ảnh thôi."',
          points: 35,
        },
        {
          prompt: 'Mai originally had plans to go to a busy music concert this Saturday.',
          questionType: QuestionType.TRUE_FALSE,
          options: [
            { id: 'true', text: 'True' },
            { id: 'false', text: 'False' },
          ...
          correctAnswer: 'false',
          explanation: 'Mai was originally thinking of staying home and reading her favorite book.',
          explanationVi: 'Mai vốn dự định ở nhà đọc sách, không phải đi nghe ca nhạc.',
          points: 30,
        },
      ],
    },
    {
      title: 'Reading Comprehension: Remote Work Careers',
      description: 'Test your understanding of asynchronous collaboration, remote job trends, and digital productivity.',
      level: EnglishLevel.INTERMEDIATE,
      difficulty: Difficulty.MEDIUM,
      timeLimit: 12,
      passingScore: 70,
      listeningLessonSlug: null,
      readingArticleSlug: 'future-of-remote-work',
      grammarLessonSlug: null,
      questions: [
        {
          prompt: 'What is a major advantage of remote work for skilled Vietnamese specialists?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'No need to pay any income taxes' },
            { id: 'b', text: 'Accessing international employment without relocating abroad' },
            { id: 'c', text: 'Never having to write emails or documentation' },
            { id: 'd', text: 'Working only ten hours per week' },
          ],
          correctAnswer: 'b',
          explanation: 'Remote work allows professionals to collaborate with global tech hubs without having to move abroad.',
          explanationVi: 'Làm việc từ xa cho phép làm việc cho các công ty quốc tế mà không phải chuyển ra nước ngoài sinh sống.',
          points: 35,
        },
        {
          prompt: 'What does effective asynchronous communication prioritize over frequent meetings?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Immediate phone calls at all hours' },
            { id: 'b', text: 'Detailed documentation, code repositories, and task tickets' },
            { id: 'c', text: 'Social media messaging' },
            { id: 'd', text: 'Daily in-person gatherings' },
          ],
          correctAnswer: 'b',
          explanation: 'Asynchronous environments rely on detailed documentation and tickets rather than constant meetings.',
          explanationVi: 'Giao tiếp bất đồng bộ ưu tiên tài liệu chi tiết, mã nguồn và hệ thống tác vụ.',
          points: 35,
        },
        {
          prompt: 'Asynchronous collaboration requires strong written English skills.',
          questionType: QuestionType.TRUE_FALSE,
          options: [
            { id: 'true', text: 'True' },
            { id: 'false', text: 'False' },
          ...
          correctAnswer: 'true',
          explanation: 'The passage highlights that asynchronous communication demands strong written English and self-discipline.',
          explanationVi: 'Mô hình này đòi hỏi kỹ năng viết tiếng Anh tốt và tính kỷ luật cao.',
          points: 30,
        },
      ],
    },
    {
      title: 'Reading Comprehension: Science of Sleep and Memory',
      description: 'Check comprehension of neurological sleep stages, NREM/REM, and memory consolidation.',
      level: EnglishLevel.INTERMEDIATE,
      difficulty: Difficulty.MEDIUM,
      timeLimit: 12,
      passingScore: 70,
      listeningLessonSlug: null,
      readingArticleSlug: 'science-of-sleep',
      grammarLessonSlug: null,
      questions: [
        {
          prompt: 'During deep NREM sleep, where are memories transferred for long-term storage?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'From the hippocampus to the neocortex' },
            { id: 'b', text: 'From the brainstem to the optic nerve' },
            { id: 'c', text: 'From the neocortex back to the hippocampus' },
            { id: 'd', text: 'To the auditory cortex exclusively' },
          ],
          correctAnswer: 'a',
          explanation: 'During deep NREM sleep, slow brainwaves transfer fragile memories from hippocampus to the neocortex.',
          explanationVi: 'Trong giấc ngủ sâu NREM, ký ức được chuyển từ hồi hải mã sang vỏ não neocortex.',
          points: 35,
        },
        {
          prompt: 'What linguistic benefit is specifically associated with REM sleep?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Instant physical energy' },
            { id: 'b', text: 'Connecting new vocabulary with existing knowledge for natural fluency' },
            { id: 'c', text: 'Complete elimination of all grammar errors forever' },
            { id: 'd', text: 'Reduced need for water' },
          ],
          correctAnswer: 'b',
          explanation: 'REM sleep synthesizes new words with existing neural webs, enabling spontaneous speech.',
          explanationVi: 'Giấc ngủ REM liên kết từ vựng mới với mạng lưới kiến thức cũ, hình thành phản xạ tự nhiên.',
          points: 35,
        },
        {
          prompt: 'Sacrificing sleep to cram vocabulary late at night is recommended for long-term retention.',
          questionType: QuestionType.TRUE_FALSE,
          options: [
            { id: 'true', text: 'True' },
            { id: 'false', text: 'False' },
          ...
          correctAnswer: 'false',
          explanation: 'Without sleep, memories are not properly consolidated and quickly fade away.',
          explanationVi: 'Thiếu ngủ sẽ khiến ký ức không được củng cố và nhanh chóng bị lãng quên.',
          points: 30,
        },
      ],
    },
    {
      title: 'Reading Comprehension: Greener Sustainable Cities',
      description: 'Assess understanding of biophilic design, clean transit, and urban sustainability solutions.',
      level: EnglishLevel.UPPER_INTERMEDIATE,
      difficulty: Difficulty.HARD,
      timeLimit: 15,
      passingScore: 70,
      listeningLessonSlug: null,
      readingArticleSlug: 'sustainable-cities',
      grammarLessonSlug: null,
      questions: [
        {
          prompt: 'What proportion of the global population is projected to reside in urban centers by 2050?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'Approximately 30%' },
            { id: 'b', text: 'Nearly 50%' },
            { id: 'c', text: 'Nearly 70%' },
            { id: 'd', text: 'Over 95%' },
          ],
          correctAnswer: 'c',
          explanation: 'The article notes urban population is projected to rise to nearly seventy percent by 2050.',
          explanationVi: 'Bài đọc nêu rõ dân số đô thị dự kiến sẽ chạm mốc gần 70% vào năm 2050.',
          points: 35,
        },
        {
          prompt: 'How does biophilic architecture mitigate the urban heat island effect?',
          questionType: QuestionType.MULTIPLE_CHOICE,
          options: [
            { id: 'a', text: 'By replacing all trees with solar mirrors' },
            { id: 'b', text: 'Through living rooftop gardens and vertical forests that absorb CO2 and lower temperatures' },
            { id: 'c', text: 'By painting buildings black' },
            { id: 'd', text: 'By installing large industrial air conditioners outdoors' },
          ],
          correctAnswer: 'b',
          explanation: 'Vegetation on structural facades absorbs CO2 and cools ambient summer temperatures.',
          explanationVi: 'Thảm thực vật trên mái và mặt đứng hấp thụ CO2 và làm mát nhiệt độ môi trường.',
          points: 35,
        },
        {
          prompt: 'Modern metro lines in Hanoi and Ho Chi Minh City help reduce urban carbon footprints.',
          questionType: QuestionType.TRUE_FALSE,
          options: [
            { id: 'true', text: 'True' },
            { id: 'false', text: 'False' },
          ...
          correctAnswer: 'true',
          explanation: 'The passage highlights that metro rail lines relieve congestion while cutting carbon footprints.',
          explanationVi: 'Bài đọc khẳng định các tuyến đường sắt đô thị giúp giảm thiểu lượng khí thải carbon.',
          points: 30,
        },
      ],
    },
